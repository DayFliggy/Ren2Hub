<template>
  <div class="overflow-visible px-1 py-[var(--space-2)]">
    <div
      class="mb-[var(--space-3)] flex items-center justify-between gap-[var(--space-3)]"
    >
      <div>
        <p
    ...
    <div
      ref="wrapperRef"
      class="hero-integration-marquee-wrapper -mx-[var(--space-2)] flex min-h-[8.5rem] items-center overflow-hidden py-10"
